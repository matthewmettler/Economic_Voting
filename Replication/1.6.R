...
# counter factual function that recovers errors based on type
# pbias= Partisan response bias
# resid= Residual response
# both= Both types of error
...
# Function that shifts color of line as it intersect both line type 
